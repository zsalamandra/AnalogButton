...
// Настройки для рисования группы прямоугольников функцией LcdBars ( uint8_t data[], uint8_t numbBars, uint8_t width, uint8_t multiplier )
...
uint8_t LcdGotoXY	   		( uint8_t x, uint8_t y );                                                           // Установка курсора в позицию x,y
uint8_t LcdChr        	( uint8_t ch );                                                                     // Вывод символа в текущей позиции
uint8_t Lcd_print     	( uint8_t x, uint8_t y, uint8_t dataArray[] );                                      // Вывод строки из переменной
uint8_t Lcd_prints      ( uint8_t x, uint8_t y, uint8_t *dataPtr );                                         // Вывод статичной строки
void Lcd_printf    	    ( uint8_t x, uint8_t y, float data, int accuracy );                                 // Вывод дробного значения
uint8_t Lcd_pixel       ( uint8_t x, uint8_t y, LcdPixelMode mode );                                        // Точка
uint8_t Lcd_line        ( uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, LcdPixelMode mode );              // Линия
uint8_t Lcd_circle      ( uint8_t x, uint8_t y, uint8_t radius, LcdPixelMode mode);                         // Окружность
uint8_t Lcd_rect_empty  ( uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, LcdPixelMode mode );              // Прямоугольник
uint8_t Lcd_rect  			( uint8_t baseX, uint8_t baseY, uint8_t height, uint8_t width, LcdPixelMode mode ); // Один
...
static const uint8_t FontLookup [][5] =
{
   ...
   { 0xB4, 0x6C, 0x24, 0x36, 0x2D },   // b 0x62  98    // переделан под знак обрыва провода
   ...
   { 0x24, 0x24, 0x24, 0x24, 0x24 },   // n 0x6E 110    // переделан под з
...
static const uint8_t deg12x16[][24] = {
...
{0x00,0xFC,0xFE,0xFE,0x06,0x06,0x06,0x06,0xFE,0xFE,0xFC,0x00,0x00,0x3F,0x7F,0x7F,0x60,0x60,0x60,0x60,0x7F,0x7F,0x3F,0x00}, //0
{0x00,0x00,0x10,0x18,0x1C,0xFE,0xFE,0xFE,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0x60,0x60,0x7F,0x7F,0x7F,0x60,0x60,0x60,0x00}, //1
{0x00,0x1C,0x1E,0x1E,0x06,0x06,0x86,0xC6,0xFE,0xFE,0x7C,0x00,0x00,0x70,0x78,0x7C,0x7E,0x6F,0x67,0x63,0x71,0x70,0x70,0x00}, //2
{0x00,0x0C,0x0E,0x0E,0x06,0x86,0x86,0x86,0xFE,0xFE,0x7C,0x00,0x00,0x30,0x70,0x70,0x60,0x61,0x61,0x61,0x7F,0x7F,0x3E,0x00}, //3
{0x00,0xFE,0xFE,0xFE,0x00,0x00,0x00,0x00,0xFE,0xFE,0xFE,0x00,0x00,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x7F,0x7F,0x7F,0x00}, //4
{0x00,0xFE,0xFE,0xFE,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x86,0x00,0x00,0x31,0x71,0x71,0x60,0x60,0x60,0x60,0x7F,0x7F,0x3F,0x00}, //5
{0x00,0xFC,0xFE,0xFE,0x86,0x86,0x86,0x86,0x8E,0x8E,0x0C,0x00,0x00,0x3F,0x7F,0x7F,0x61,0x61,0x61,0x61,0x7F,0x7F,0x3F,0x00}, //6
{0x00,0x0E,0x0E,0x0E,0x06,0x06,0x86,0xC6,0xFE,0xFE,0x7E,0x00,0x00,0x00,0x00,0x00,0x7E,0x7F,0x7F,0x03,0x01,0x00,0x00,0x00}, //7
{0x00,0x7C,0xFE,0xFE,0x86,0x86,0x86,0x86,0xFE,0xFE,0x7C,0x00,0x00,0x3E,0x7F,0x7F,0x61,0x61,0x61,0x61,0x7F,0x7F,0x3E,0x00}, //8
{0x00,0xFC,0xFE,0xFE,0x86,0x86,0x86,0x86,0xFE,0xFE,0xFC,0x00,0x00,0x30,0x71,0x71,0x61,0x61,0x61,0x61,0x7F,0x7F,0x3F,0x00}, //9
